...
public class DebitExcelExporter {
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    //private List<User> listUsers;
    private List<Debit> listCredit;

    public DebitExcelExporter(List<Debit> listCredit) {
    ...
    private void writeHeaderLine() {
        ...
        createCell(row, 4, "Debit_type_id", style);
